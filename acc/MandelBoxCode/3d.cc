...
inline void MultiplyMatrixByVector(double *resultvector, const double *matrix, const double *pvector)
{
...
void UnProject(double winX, double winY, const CameraParams &camP, vec3 &obj)
{
